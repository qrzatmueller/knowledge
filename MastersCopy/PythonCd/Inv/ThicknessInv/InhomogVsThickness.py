...
What happens with a smaller inhomogenity?

This file is not set up yet like the long beam one, with cases and identification. I should do that and
delete this comment
'''
...
file_path = os.path.join(mt_eq_path, 'CodeAsterModels/YACSauto/YACS_BW_TH/autoRes/InHvsThck/resInHsmall_F0.txt')
file_path2 = os.path.join(mt_eq_path, 'CodeAsterModels/YACSauto/YACS_BW_TH/autoRes/InHvsThck/resInHsmall_F1.txt')
file_path3 = os.path.join(mt_eq_path, 'CodeAsterModels/YACSauto/YACS_BW_TH/autoRes/InHvsThck/resInHsmall_F2.txt')
...
ax.plot(Xpos, responsesP[n,:].real, label = "thck05")
ax.plot(Xpos, responsesP2[n,:].real, label = "thck075")
...
ax.plot(Xpos, responsesP[n,:].imag, label = "thck05")
ax.plot(Xpos, responsesP2[n,:].imag, label = "thck075")
...
ax2.plot(Xpos, np.abs(responsesP[n,:]), label = "thck05")
ax2.plot(Xpos, np.abs(responsesP2[n,:]), label = "thck075")
ax2.plot(Xpos, np.abs(responsesP3[n,:]), label = "thck1")
ax.set_xlabel("Position (x)")
ax.set_ylabel("Magnitude")
plt.legend()
ax3 = fig.add_subplot(224)
ax3.plot(Xpos, np.angle(responsesP[n,:]), label = "thck05")
ax3.plot(Xpos, np.angle(responsesP2[n,:]), label = "thck075")
...
ax.plot(Xpos, responsesP[n,:].real, responsesP[n,:].imag, label = "thck05")
ax.plot(Xpos, responsesP2[n,:].real, responsesP2[n,:].imag, label = "thck075")
